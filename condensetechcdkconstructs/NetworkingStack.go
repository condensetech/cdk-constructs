...
// The jsii proxy struct for NetworkingStack
type jsiiProxy_NetworkingStack struct {
	internal.Type__awscdkStack
	jsiiProxy_INetworking
}

func (j *jsiiProxy_NetworkingStack) Account() *string {
	var returns *string
	_jsii_.Get(
		j,
		"account",
...
func (j *jsiiProxy_NetworkingStack) ArtifactId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"artifactId",
...
func (j *jsiiProxy_NetworkingStack) AvailabilityZones() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"availabilityZones",
...
func (j *jsiiProxy_NetworkingStack) BastionHost() awsec2.BastionHostLinux {
...
func (j *jsiiProxy_NetworkingStack) BundlingRequired() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"bundlingRequired",
...
func (j *jsiiProxy_NetworkingStack) Dependencies() *[]awscdk.Stack {
...
func (j *jsiiProxy_NetworkingStack) Environment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environment",
...
func (j *jsiiProxy_NetworkingStack) HasPrivateSubnets() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"hasPrivateSubnets",
...
func (j *jsiiProxy_NetworkingStack) IsolatedSubnets() *awsec2.SubnetSelection {
...
func (j *jsiiProxy_NetworkingStack) Nested() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"nested",
...
func (j *jsiiProxy_NetworkingStack) NestedStackParent() awscdk.Stack {
	var returns awscdk.Stack
	_jsii_.Get(
		j,
		"nestedStackParent",
...
func (j *jsiiProxy_NetworkingStack) NestedStackResource() awscdk.CfnResource {
...
func (j *jsiiProxy_NetworkingStack) Node() constructs.Node {
...
func (j *jsiiProxy_NetworkingStack) NotificationArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"notificationArns",
...
func (j *jsiiProxy_NetworkingStack) Partition() *string {
	var returns *string
	_jsii_.Get(
		j,
		"partition",
...
func (j *jsiiProxy_NetworkingStack) PrivateSubnets() *awsec2.SubnetSelection {
	var returns *awsec2.SubnetSelection
	_jsii_.Get(
		j,
		"privateSubnets",
...
func (j *jsiiProxy_NetworkingStack) PublicSubnets() *awsec2.SubnetSelection {
	var returns *awsec2.SubnetSelection
	_jsii_.Get(
		j,
		"publicSubnets",
...
func (j *jsiiProxy_NetworkingStack) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_NetworkingStack) StackId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stackId",
...
func (j *jsiiProxy_NetworkingStack) StackName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stackName",
...
func (j *jsiiProxy_NetworkingStack) Synthesizer() awscdk.IStackSynthesizer {
...
func (j *jsiiProxy_NetworkingStack) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_NetworkingStack) TemplateFile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateFile",
...
func (j *jsiiProxy_NetworkingStack) TemplateOptions() awscdk.ITemplateOptions {
...
func (j *jsiiProxy_NetworkingStack) TerminationProtection() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkingStack) UrlSuffix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"urlSuffix",
...
func (j *jsiiProxy_NetworkingStack) Vpc() awsec2.IVpc {
...
func NewNetworkingStack(scope constructs.Construct, id *string, props *NetworkingStackProps) NetworkingStack {
	...
	if err := validateNewNetworkingStackParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_NetworkingStack)SetTerminationProtection(val *bool) {
...
func NetworkingStack_IsConstruct(x interface{}) *bool {
	...
	if err := validateNetworkingStack_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func NetworkingStack_IsStack(x interface{}) *bool {
	...
	if err := validateNetworkingStack_IsStackParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func NetworkingStack_Of(construct constructs.IConstruct) awscdk.Stack {
	...
	if err := validateNetworkingStack_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns awscdk.Stack
...
func (n *jsiiProxy_NetworkingStack) AddDependency(target awscdk.Stack, reason *string) {
...
func (n *jsiiProxy_NetworkingStack) AddMetadata(key *string, value interface{}) {
...
func (n *jsiiProxy_NetworkingStack) AddTransform(transform *string) {
...
func (n *jsiiProxy_NetworkingStack) AllocateLogicalId(cfnElement awscdk.CfnElement) *string {
...
func (n *jsiiProxy_NetworkingStack) ExportStringListValue(exportedValue interface{}, options *awscdk.ExportValueOptions) *[]*string {
...
func (n *jsiiProxy_NetworkingStack) ExportValue(exportedValue interface{}, options *awscdk.ExportValueOptions) *string {
...
func (n *jsiiProxy_NetworkingStack) FormatArn(components *awscdk.ArnComponents) *string {
...
func (n *jsiiProxy_NetworkingStack) GetLogicalId(element awscdk.CfnElement) *string {
...
func (n *jsiiProxy_NetworkingStack) RegionalFact(factName *string, defaultValue *string) *string {
...
func (n *jsiiProxy_NetworkingStack) RenameLogicalId(oldId *string, newId *string) {
...
func (n *jsiiProxy_NetworkingStack) ReportMissingContextKey(report *cloudassemblyschema.MissingContext) {
...
func (n *jsiiProxy_NetworkingStack) Resolve(obj interface{}) interface{} {
...
func (n *jsiiProxy_NetworkingStack) SplitArn(arn *string, arnFormat awscdk.ArnFormat) *awscdk.ArnComponents {
...
func (n *jsiiProxy_NetworkingStack) ToJsonString(obj interface{}, space *float64) *string {
...
func (n *jsiiProxy_NetworkingStack) ToString() *string {
	var returns *string
...
func (n *jsiiProxy_NetworkingStack) ToYamlString(obj interface{}) *string {

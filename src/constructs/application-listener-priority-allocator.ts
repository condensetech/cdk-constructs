...
export class ApplicationListenerPriorityAllocator extends ApplicationListenerPriorityAllocatorBase {
  static fromPriorityAllocatorName(
    scope: Construct,
    id: string,
    priorityAllocatorName: string,
  ): IApplicationListenerPriorityAllocator {
    const serviceToken = ssm.StringParameter.valueForStringParameter(
      scope,
      `/service-tokens/priority-allocators/${priorityAllocatorName}`,
    );
  ...
  constructor(scope: Construct, id: string, props: ApplicationListenerPriorityAllocatorProps) {
    ...
    new ssm.StringParameter(this, 'ServiceTokenParameter', {
